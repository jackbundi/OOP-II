...
question_One.cpp:7:9: note: previous declaration as ‘int arg1’
     int arg1;
         ^
oopii@oopiibox:~/Desktop$ ls
3.1.1.cpp       code10.cpp  code5.cpp  code8.cpp         question_Two.cpp
a.out           code11.cpp  code6.cpp  code9.cpp
assignment_One  code4cpp    code7.cpp  question_One.cpp
oopii@oopiibox:~/Desktop$ g++ question_Two.cpp
oopii@oopiibox:~/Desktop$ ./a.out 
A
oopii@oopiibox:~/Desktop$ clear
